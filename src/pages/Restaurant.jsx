...
import {addToBasket, updateItem, deleteItem} from "../redux/actions/basketAction.js";
                ...
                <div className="my-10 ">
                    <div className="flex flex-col gap-2 mt-5 items-center text-xl font-semibold">
                        <div className="w-full items-center gap-6 flex justify-center">
                            <span className='w-[40%] h-[10px] '><hr className="border-gray-200"/></span>
                            <FaDumpsterFire className="text-4xl text-red-600"/>
                            <span className='w-[40%]'><hr className="border-gray-200"/></span>
                        </div>

                        <p>Populer</p>

                        <p className="text-gray-600 font-semibold">Restorantin en cok tercih edilen yemekleri</p>
                    </div>
                        ...
                        productState.isLoading ?
                            ...
                            productState.error ?
                                ...
                                productState.products.map((product) => (
                                    <ProductCard key={product.id} product={product} handleAdd={handleAdd} handleDelete={handleDelete} />
                                ))
                    }
                </div>
            </Container>
